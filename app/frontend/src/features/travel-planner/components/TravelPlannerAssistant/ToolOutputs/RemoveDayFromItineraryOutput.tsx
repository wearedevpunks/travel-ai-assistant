...
type RemoveDayResult = {
  itineraryId: string
  itinerary?: TravelItinerary
  removedDayId?: string
}

export const RemoveDayFromItineraryOutput = ({
  toolInvocation,
}: ToolOutputProps) => {
  ...
  useEffect(() => {
    if (
      ...
      const result = toolInvocation.result as RemoveDayResult
        ...
        <div className="flex items-start">
          ...
          <div className="ml-3">
            <h3 className="text-base font-medium text-gray-900">
              Removing day from your itinerary...
            </h3>
    ...
    return (
      <div className="bg-white border border-red-200 rounded-lg p-4 my-2">
        <div className="flex items-start">
          ...
          <div className="ml-3">
            <h3 className="text-base font-medium text-gray-900">
              Failed to remove day from itinerary
            </h3>
            <div className="mt-1 text-sm text-gray-600">
              {typeof toolInvocation.error === "string"
                ? toolInvocation.error
                : "Unable to remove a day from your itinerary. Please try again."}
            </div>
          </div>
        </div>
      </div>
  ...
  // Cast result to remove day data
  const result = toolInvocation.result as RemoveDayResult
    ...
    <div className="bg-white border border-green-200 rounded-lg p-4 my-2">
      <div className="flex items-start">
        ...
        <div className="ml-3">
          ...
          <div className="mt-1 text-sm text-gray-600">
            A day has been removed from your travel plan
          </div>
          <div className="mt-4">
            <button
